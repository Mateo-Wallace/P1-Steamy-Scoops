...
function renderYoutube(videoData) {
	...
	for (let i = 0; i < 3; i++) {
		...
		urlATag.setAttribute('class', 'card w-custom m-2 flex rounded-xl bg-slate-800 p-0 bounce-custom border-none hover:border-solid border-2 border-purple-700')
...
function renderSteamNews(newsData) {
	...
	for (let i = 0; i < 3; i++) {
		...
		urlATag.setAttribute('class', 'w-custom m-2 card flex rounded-xl p-0 bg-slate-800 bounce-custom border-none hover:border-solid border-2 border-purple-700')
